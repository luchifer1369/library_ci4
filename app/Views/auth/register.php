...
<body>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="brand-logo">Daftar Akun</div>
            <div class="brand-subtitle">Mulailah Membaca dengan Akses Free Trial Premium</div>
            ...
            <form action="<?= base_url('register') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group-custom">
                        <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control-custom" placeholder="Nama Lengkap Anda" value="<?= old('nama_lengkap') ?>" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group-custom">
                        <input type="password" name="confirm_password" id="confirm_password" class="form-control-custom" placeholder="Masukkan kembali password Anda" required>
